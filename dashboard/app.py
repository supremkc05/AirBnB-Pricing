...
# Page 2: Detailed Analysis
    ...
    with col1:
        ...
        # Add trendline manually using sklearn
    ...
    # Market Segmentation
    st.markdown('<h3 class="section-header">🎯 Market Segmentation</h3>', unsafe_allow_html=True)
    ...
    with col1:
        ...
        fig = px.pie(
            ...
            color_discrete_sequence=['#FF5A5F', '#FF385C', '#FD1D1D', '#8B0000']
        )
        st.plotly_chart(fig, use_container_width=True)
    
    with col2:
        # Segment characteristics
        segment_chars = filtered_df.groupby('price_segment')[['availability_365', 'minimum_nights', 'number_of_reviews']].mean()
        
        fig = px.bar(
            segment_chars.reset_index(),
            x='price_segment',
            y='availability_365',
    ...
    # Reviews Analysis
    st.markdown('<h3 class="section-header">⭐ Reviews Analysis</h3>', unsafe_allow_html=True)
